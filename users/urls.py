...
urlpatterns = [
     ...
     path('signup-error/', views.signup_error, name='signup_error'),
    ...
    path('profile/edit/error/<int:id>', views.profile_edit_error, name='profile_edit_error'),
    path('profile/add/<int:id>', views.profile_add, name='profile_add'),
    path('profile/add/error/<int:id>', views.profile_add_error, name='profile_add_error'),
